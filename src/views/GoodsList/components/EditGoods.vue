    ...
    >
      ...
      >
        ...
        <el-tab-pane label="商品内容" name="5">
          ...
          <el-button type="primary" @click="addGoodsBtn">确定</el-button>
        </el-tab-pane>
      </el-tabs>
    </el-form>
    <!-- 预览对话框 -->
...
import { editGoods, assignGoodsById } from '@/api/goods'
export default {
  async created () {
    this.getCategoryList()
    const res = await assignGoodsById(this.$store.getters.goodsId)
    console.log(res.data.data)
    this.addGoodsForm = res.data.data
  },
  data () {
    return {
      goodsId: this.$store.getters.goodsId,
      id: null,
      activeName: '1',
      addGoodsForm: {
        goods_name: '',
  ...
  methods: {
    ...
    async addGoodsBtn () {
      ...
      try {
        ...
        await editGoods(this.goodsId, this.addGoodsForm)
        // console.log(res)
        this.activeName = '7'
